...
const Project: React.FC = () => {
  return (
    <section
      id="projects"
      className="relative isolate min-h-screen overflow-hidden px-4 py-20 sm:px-6 lg:px-20 lg:py-24"
    >
      ...
      <div className="mb-10 grid items-end gap-6 md:grid-cols-[1fr_auto]">
        ...
        <a
          ...
          className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-gray-200 bg-white/70 px-5 py-3 text-sm font-bold text-gray-500 shadow-sm backdrop-blur transition hover:border-teal-200 hover:text-teal-500 sm:w-fit dark:border-white/10 dark:bg-white/[0.05] dark:text-white dark:hover:border-teal-200"
        >
          GitHub
          <FiArrowUpRight />
        </a>
      ...
      <div className="flex flex-col items-center justify-center md:flex-row">
        <div className="grid w-full grid-cols-1 gap-5 sm:gap-6 md:grid-cols-2 lg:grid-cols-3 dark:text-white">
