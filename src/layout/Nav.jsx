  ...
  return (
    <>
      <div className=" bg-white dark:bg-[#16181d]">
        <div className="text-xl md:hidden pt-2 pl-8 bg-gradient-to-r from-teal-400 via-teal-300 to-teal-200 bg-clip-text text-transparent shadow-lg shadow-teal-100 font-roboto animate-text dark:shadow-purple-100 pb-2">
          Lawrence Li
        </div>
        <VscMenu
          onClick={() => {
        ...
        <nav className="md:block hidden bg-white top-0 w-full fixed z-1000 dark:bg-[#16181d]">
          <div className="flex justify-between items-center h-14 p-5 shadow-lg shadow-teal-100 dark:shadow-purple-100">
            <div className="flex flex-row items-center gap-4 lg:pl-12 md:pl-6">
